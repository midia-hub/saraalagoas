...
export default function FormularioError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[FormularioConversaoError]', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="max-w-sm w-full text-center">
        ...
        <h2 className="text-lg font-bold text-slate-800 mb-2">Erro ao carregar formulário</h2>
