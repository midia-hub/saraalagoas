...
const cards = [
  ...
  { href: '/xp26-resultados', label: 'Resultados Pesquisa XP26', icon: BarChart3, desc: 'Dashboard público com resultados da pesquisa (abre em nova aba)', permission: 'dashboard', external: true },
