...
export default function ConversaoSucessoPage() {
    ...
    useEffect(() => {
        adminFetchJson<{ accepted: string; reconciled: string }>('/api/admin/consolidacao/conversion-messages')
            .then((data) => {
