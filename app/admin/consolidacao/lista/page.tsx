...
import {
  ...
  LayoutDashboard, List, Target, Heart
} from 'lucide-react'
...
const DashboardChartsLazy = dynamic(
  ...
  { ssr: false, loading: () => <div className="flex items-center justify-center py-16"><div className="w-8 h-8 border-2 border-[#c62737] border-t-transparent rounded-full animate-spin" /></div> }
)
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {activeTab === 'dashboard' && (
            <DashboardChartsLazy
              ...
              chartByTipo={chartByTipo}
              chartByCulto={chartByCulto}
              chartByChurch={chartByChurch}
              chartByTeam={chartByTeam}
              chartByCell={chartByCell}
            />
          )}
        </div>
      </div>
