...
const personBaseSchema = z.object({
  ...
  rg: optionalString,
  rg_issuing_agency: optionalString,
  rg_uf: optionalString,
  cpf: optionalString,
  ...
  is_new_convert: optionalBoolean,
  accepted_jesus: optionalBoolean,
  accepted_jesus_at: optionalString,
